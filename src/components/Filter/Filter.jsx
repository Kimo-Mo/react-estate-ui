...
const Filter = () => {
  ...
  return (
    <div className="filter text-capitalize">
      <h1 className="mb-4 searchTitle">
        Search results for <b>London</b>
      </h1>
      <button
        className="filterTitle mainBtn"
        onClick={() => setFilterIsOpen((prev) => !prev)}>
        filter <img src="/filter-icon.png" alt="filter icon" />
      </button>

      <div
        style={{
          height: filterIsOpen ? "auto" : "0",
          opacity: filterIsOpen ? 1 : 0,
          transition: "all 0.15s",
          zIndex: filterIsOpen ? 1 : -1,
        }}>
        <div className="top">
